...
export type {
  IMaskedTabBarIcon, IMaskedTabBarLabel, IMaskedTabBarList, IMaskedTabBarPalette, IMaskedTabBarRoot, IMaskedTabBarTrigger, IMaskedTabIconState,
  TMaskedTabBarTheme
} from "./types";
export {
  MaskedTabBar, MaskedTabBarIcon, MaskedTabBarLabel, MaskedTabBarList, MaskedTabBarRoot, MaskedTabBarTrigger
};
